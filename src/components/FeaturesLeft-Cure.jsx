...
import cure from "../assets/images/tld-cure-screen.png";
import { CheckArrowIcon } from "../assets/icons/CheckArrowIcon";

export const FeaturesLeftCure = () => {
  return (
    <section
          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="mx-auto lg:mx-auto w-11/12 sm:w-4/5 md:w-3/4 lg:w-unset">
              <span className="block-subtitle">
                Zombie. Human. Or something in between.
              </span>
              <h2 className="mt-6 mb-8 text-4xl lg:text-5xl block-big-title">
                Cure the City. Save the City.
              </h2>
              <p className="mb-10 text-secondaryText leading-loose">
                Search the city for supplies, train important skills, and work
                together to save the city. And yourselves.
              </p>
              <ul className="mb-6 text-primaryText">
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Online multiplayer, sandbox-style, game</span>
                </li>
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>An ever evolving city</span>
                </li>
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Unique rotters keep you one your toes</span>
                </li>
              </ul>
            </div>
          </div>
